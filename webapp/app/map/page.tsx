      ...
      <div className="relative z-[1] px-8 py-8 max-w-7xl space-y-8">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            { icon: Zap,    label: "Data Archive",     value: "2015–2026" },
        ...
        <p className="text-[9px] text-white/20 font-mono pb-4">
          Source: NOAA Integrated Surface Database (ISD) 2015–2026 · Rule 803(8) public records · Indian Evidence Act s74/s78 · IT Act s65B · Wind threshold 17.2 m/s (Beaufort 8) · Exceedance ≥ 3 hours
        </p>
      </div>
    </div>
  );
