...
<div class="footer">Generated by DREADNOUGHT ASRE &nbsp;·&nbsp; NOAA ISD public record (US FRE 803(8) source data)<br>Decision-support only · Not legal advice · Admissibility subject to jurisdictional certification.</div>
    ...
    <div className="relative min-h-screen bg-[#040810] overflow-hidden">
      ...
      <div className="relative z-[1] px-8 pt-10 pb-6 border-b border-white/8">
        <PageHeader
          ...
          description="Submit your claim details. ASRE returns an evidence-grade verdict in under 500ms."
        />
      </div>
            ...
            {!result && !error && !loading && (
              <div className="glass-card-dark rounded-2xl p-8 text-center border border-white/8 shadow-glass-md">
                ...
                <p className="text-sm text-white/35 mt-2 leading-relaxed max-w-xs mx-auto">
                  Fill in the claim details and submit. ASRE will return an evidence-grade verdict in under 500ms.
                </p>
            ...
            <div className="glass-card-dark rounded-2xl p-5 border border-white/6">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { label: "Public-record provenance", detail: "NOAA ISD (US FRE 803(8) source data)" },
                ].map(({ label, detail }) => (
